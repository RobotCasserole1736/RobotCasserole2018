...
/**
 * Averaging Filter - Class which defines a simple average filter. After
...
public class AveragingFilter {
	...
	/**
	 * Filter - add a new input to the filter and get the current output from the
	 * filter
	 * 
	 * @param input
	 *            - new value to add to the filter
