...
public class Robot extends TimedRobot {
	...
	public void robotInit() {
		...
		// Load any saved calibration values (must be last to ensure all calibrations
	...
	public void autonomousPeriodic() {
		...
		try {
			...
			ElevatorCtrl.getInstance().sampleSensors();
			IntakeControl.getInstance().sampleSensors();
			IntakeControl.getInstance().setMotorCurrents(pdp.getCurrent(RobotConstants.PDP_INTAKE_LEFT),
					pdp.getCurrent(RobotConstants.PDP_INTAKE_RIGHT));
	...
	public void teleopPeriodic() {
		...
		try {
			...
			Drivetrain.getInstance()
					.setForwardReverseCommand(DriverController.getInstance().getDriverForwardReverseCommand());
			...
			IntakeControl.getInstance().setEjectDesired(OperatorController.getInstance().getEjectCmd()
					|| DriverController.getInstance().getDriverEjectCmd());
			...
			IntakeControl.getInstance().setThrowDesired(OperatorController.getInstance().getThrowCmd()
					|| DriverController.getInstance().getDriverThrowCmd());
	...
	public void initLoggingChannels() {
		...
		CsvLogger.addLoggingFieldDouble("DT_Right_Wheel_Speed_Act_RPM", "RPM", "getRightWheelSpeedAct_RPM",
				Drivetrain.getInstance());
		CsvLogger.addLoggingFieldDouble("DT_Right_Wheel_Speed_Des_RPM", "RPM", "getRightWheelSpeedDes_RPM",
				Drivetrain.getInstance());
		CsvLogger.addLoggingFieldDouble("DT_Left_Wheel_Speed_Act_RPM", "RPM", "getLeftWheelSpeedAct_RPM",
				Drivetrain.getInstance());
		CsvLogger.addLoggingFieldDouble("DT_Left_Wheel_Speed_Des_RPM", "RPM", "getLeftWheelSpeedDes_RPM",
				Drivetrain.getInstance());
		CsvLogger.addLoggingFieldDouble("DT_Heading_Des", "deg", "getHeadingDes_deg", Drivetrain.getInstance());
		CsvLogger.addLoggingFieldDouble("DT_Motor_L1_Current", "A", "getMasterMotorCurrent",
				Drivetrain.getInstance().leftGearbox);
		CsvLogger.addLoggingFieldDouble("DT_Motor_L2_Current", "A", "getSlave1MotorCurrent",
				Drivetrain.getInstance().leftGearbox);
		CsvLogger.addLoggingFieldDouble("DT_Motor_L3_Current", "A", "getSlave2MotorCurrent",
				Drivetrain.getInstance().leftGearbox);
		CsvLogger.addLoggingFieldDouble("DT_Motor_R1_Current", "A", "getMasterMotorCurrent",
				Drivetrain.getInstance().rightGearbox);
		CsvLogger.addLoggingFieldDouble("DT_Motor_R2_Current", "A", "getSlave1MotorCurrent",
				Drivetrain.getInstance().rightGearbox);
		CsvLogger.addLoggingFieldDouble("DT_Motor_R3_Current", "A", "getSlave2MotorCurrent",
				Drivetrain.getInstance().rightGearbox);
		CsvLogger.addLoggingFieldDouble("DT_Left_Meas_Current", "A", "getTotalCurrent",
				Drivetrain.getInstance().leftGearbox);
		CsvLogger.addLoggingFieldDouble("DT_Right_Meas_Current", "A", "getTotalCurrent",
				Drivetrain.getInstance().rightGearbox);
		...
		CsvLogger.addLoggingFieldDouble("DT_Current_Limit_Factor", "factor", "getLimitFactor",
				Drivetrain.getInstance());
		CsvLogger.addLoggingFieldDouble("DT_FwdRev_Cmd", "cmd", "getDriverForwardReverseCommand",
				DriverController.getInstance());
		CsvLogger.addLoggingFieldDouble("DT_Rotate_Cmd", "cmd", "getDriverLeftRightCommand",
				DriverController.getInstance());
		CsvLogger.addLoggingFieldDouble("DT_Pose_Angle", "deg", "getAngle", Gyro.getInstance());
		CsvLogger.addLoggingFieldBoolean("Elbow_Raise_Command", "cmd", "getDriverElbowRaiseCmd",
				DriverController.getInstance());
		CsvLogger.addLoggingFieldBoolean("Elbow_Lower_Command", "cmd", "getDriverElbowLowerCmd",
				DriverController.getInstance());
		CsvLogger.addLoggingFieldDouble("Elbow_Motor_Command", "cmd", "getMotorCmd", ElbowControl.getInstance());
		CsvLogger.addLoggingFieldBoolean("Elbow_Upper_Limit_Reached", "bool", "isUpperLimitReached",
				ElbowControl.getInstance());
		CsvLogger.addLoggingFieldBoolean("Intake_Intake_Desired", "cmd", "getIntakeCmd",
				OperatorController.getInstance());
		CsvLogger.addLoggingFieldBoolean("Operator_Eject_Desired", "cmd", "getEjectCmd",
				OperatorController.getInstance());
		CsvLogger.addLoggingFieldBoolean("Driver_Eject_Desired", "cmd", "getDriverEjectCmd",
				DriverController.getInstance());
		CsvLogger.addLoggingFieldBoolean("Intake_IntakeOvrd_Desired", "cmd", "getIntakeOverideCmd",
				OperatorController.getInstance());
		CsvLogger.addLoggingFieldBoolean("Operator_Throw_Desired", "cmd", "getThrowCmd",
				OperatorController.getInstance());
		CsvLogger.addLoggingFieldBoolean("Driver_Throw_Desired", "cmd", "getDriverThrowCmd",
				DriverController.getInstance());
		CsvLogger.addLoggingFieldBoolean("Intake_Current_Limit_Exceeded", "bool", "getCurrentLimitExceeded",
				IntakeControl.getInstance());
		CsvLogger.addLoggingFieldDouble("Intake_Right_Motor_Cmd", "cmd", "getRightMotorCmd",
				IntakeControl.getInstance());
		...
		CsvLogger.addLoggingFieldBoolean("Elev_Continuous_Mode_Desired", "cmd", "getElevCntrlModeCmd",
				OperatorController.getInstance());
		CsvLogger.addLoggingFieldDouble("Elev_Continuous_Mode_Cmd", "cmd", "getElevCntrlModeCmdSpeed",
				OperatorController.getInstance());
		...
		CsvLogger.addLoggingFieldBoolean("Elev_Upper_Limit_SW_1_State", "bit", "getUpperLimitSwitchStage1State",
				ElevatorCtrl.getInstance());
		CsvLogger.addLoggingFieldBoolean("Elev_Upper_Limit_SW_2_State", "bit", "getUpperLimitSwitchStage2State",
				ElevatorCtrl.getInstance());
		CsvLogger.addLoggingFieldBoolean("Elev_Upper_Limit_Reached", "bit", "getUpperTravelLimitReached",
				ElevatorCtrl.getInstance());
		CsvLogger.addLoggingFieldBoolean("Elev_Lower_Limit_Reached", "bit", "getLowerTravelLimitReached",
				ElevatorCtrl.getInstance());
		...
		CsvLogger.addLoggingFieldDouble("PDP_Current_Elevator_One", "A", "getCurrent", pdp,
				RobotConstants.PDP_ELEVATOR_ONE);
		CsvLogger.addLoggingFieldDouble("PDP_Current_Intake_Left", "A", "getCurrent", pdp,
				RobotConstants.PDP_INTAKE_LEFT);
		CsvLogger.addLoggingFieldDouble("PDP_Current_Intake_Right", "A", "getCurrent", pdp,
				RobotConstants.PDP_INTAKE_RIGHT);
		CsvLogger.addLoggingFieldDouble("PDP_Current_Climber_Left_One", "A", "getCurrent", pdp,
				RobotConstants.PDP_CLIMBER_LEFT_ONE);
		CsvLogger.addLoggingFieldDouble("PDP_Current_Climber_Left_Two", "A", "getCurrent", pdp,
				RobotConstants.PDP_CLIMBER_LEFT_TWO);
		CsvLogger.addLoggingFieldDouble("PDP_Current_Climber_Right_One", "A", "getCurrent", pdp,
				RobotConstants.PDP_CLIMBER_RIGHT_ONE);
		CsvLogger.addLoggingFieldDouble("PDP_Current_Climber_Right_Two", "A", "getCurrent", pdp,
				RobotConstants.PDP_CLIMBER_RIGHT_TWO);
	...
	private void initDriverView() {
		...
		CasseroleDriverView.newWebcam("Driver_cam", RobotConstants.DRIVER_CAMERA_URL, 50, 50, 0); // must use firefox.
																									// No idea why.
	...
	private void updateRTPlot() {
		...
		CasseroleWebPlots.addSample("Driver_FwdRev_Cmd", time,
				DriverController.getInstance().getDriverForwardReverseCommand());
		CasseroleWebPlots.addSample("Driver_Rotate_Cmd", time,
				DriverController.getInstance().getDriverLeftRightCommand());
		CasseroleWebPlots.addSample("DT_Right_Wheel_Speed_Act", time,
				Drivetrain.getInstance().getRightWheelSpeedAct_RPM());
		CasseroleWebPlots.addSample("DT_Right_Wheel_Speed_Des", time,
				Drivetrain.getInstance().getRightWheelSpeedDes_RPM());
		CasseroleWebPlots.addSample("DT_Left_Wheel_Speed_Act", time,
				Drivetrain.getInstance().getLeftWheelSpeedAct_RPM());
		CasseroleWebPlots.addSample("DT_Left_Wheel_Speed_Des", time,
				Drivetrain.getInstance().getLeftWheelSpeedDes_RPM());
		...
		CasseroleWebPlots.addSample("Elevator_Desired_Height", time,
				ElevatorCtrl.getInstance().getElevDesiredHeight_in());
	...
	private void updateWebStates() {
		...
		CasseroleWebStates.putBoolean("Elevator Stage 1 Limit Sw State",
				ElevatorCtrl.getInstance().getUpperLimitSwitchStage1State());
		CasseroleWebStates.putBoolean("Elevator Stage 2 Limit Sw State",
				ElevatorCtrl.getInstance().getUpperLimitSwitchStage2State());
	}
...
}// blood of The Aeons shall only empower the most ancient and noble Zyraxus,
	// Eater of Light
