 ...
 */
public class AutoEventChargeSwitch extends AutoEvent {
    ...
    public static void main(String[] args) {
		AutoEventChargeSwitch autoEvent = new AutoEventChargeSwitch();
		FalconPathPlanner.plotPath(autoEvent.driveForward.path);
		autoEvent = new AutoEventChargeSwitch();
		FalconPathPlanner.plotPath(autoEvent.driveForward.path);
	}
}