...
public class OperatorController {
	...
	/**
	 * 
	 * @return True if the operator wants the run the elevator in continuous mode,
	 *         false otherwise
	 */
	public boolean getElevCntrlModeCmd() {
		...
		if (operatorController.getTriggerAxis(Hand.kRight) > 0.05
	...
	/**
	 * 
	 * @return The continuous motor command from the driver. -1 is full down, 1 is
	 *         full up, 0 is stop.
	 */
