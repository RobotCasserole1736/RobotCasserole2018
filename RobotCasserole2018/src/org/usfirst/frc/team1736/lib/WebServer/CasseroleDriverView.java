...
public class CasseroleDriverView {
	 ...
	 * 
	 * @param name_in
	 *            Name of the value to display. Also used to reference the value
	 *            when updating it.
	 * @param min_in
	 *            Minimum value displayed on the dial.
	 * @param max_in
	 *            Maximum value displayed on the dial.
	 * @param step_in
	 *            Step value between dial tick marks.
	 * @param min_acceptable_in
	 *            Lower limit of green display area on drawn dial.
	 * @param max_acceptable_in
	 *            Upper limit of green display area on drawn dial.
	 */
	 ...
	 * 
	 * @param url_in
	 *            Web address of the motion JPEG stream from the camera.
	 * @param marker_x
	 *            X draw position of the crosshairs (in percent - 0% is full left,
	 *            100% is full right).
	 * @param marker_y
	 *            Y draw position of the crosshairs (in percent - 0% is full top,
	 *            100% is full bottom).
	 * @param img_rotate_deg
	 *            Degrees clockwise to rotate the image to be displayed. Crosshairs
	 *            are drawn on top of the already-rotated image.
	 * @param name_in
	 *            Name of the web stream. Internal uses only, currently...
	 */
	 ...
	 *            when updating it.
	 * @param color_in
	 *            Color to display. Currently, only supported values are "red",
	 *            "yellow", and "green".
	 */
	 ...
	 * 
	 * @param name_in
	 *            Name of the dial to update
	 * @param value_in
	 *            Value to display on the dial. Should be in the min/max range
	 *            assigned for the dial, or the displayed value will be truncated.
	 */
	 ...
	 *            Name of the dial to update
	 * @param value_in
	 *            Value to display on the indicator.
	 */
	// might be called from different threads, but all calls go to the web server
	// thread.
